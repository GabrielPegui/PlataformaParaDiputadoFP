...
if($funcion == 1){
   ...
   $sql=" select cedula,nombre,apellido,telefono,sector from miembros where funcion=2 order by sector";
...
$v_subtitulo='EQUIPO ENLACES POR SECTOR';
...
$pdf->Cell(28, 5, "Telefono", 1, 0, "C",TRUE);
$pdf->Cell(28, 5, "Sector", 1, 1, "C",TRUE);
    ...
    // $pdf->Cell(24, 5, "Cedula", 1, 0, "C",TRUE);
     ...
     while ($fila = $resultado->fetch_assoc()) {
        $contador = $contador+1;
           ...
           $pdf->Cell(28, 5, $fila['telefono'], 1, 0, "L");
           $pdf->Cell(28, 5, $fila['sector'] , 1, 1, "L");
