...
if($funcion == 3){
   ...
   $sql="select cedula_afil,nombre,apellido,telefono_afil,sector from padron_compromiso where cedula=$cedula_user";
...
$v_subtitulo='EQUIPO SIMPATIZANTES DE: '.$nombreC.' '.$apellidoC;
    ...
    // $pdf->Cell(24, 5, "Cedula", 1, 0, "C",TRUE);
     ...
     while ($fila = $resultado->fetch_assoc()) {
        $contador = $contador+1;
           ...
           $pdf->Cell(25, 5, $fila['cedula_afil'], 1, 0, "R");
           $pdf->Cell(60, 5, $fila['nombre'], 1, 0, "L");
           $pdf->Cell(60, 5, $fila['apellido'], 1, 0, "L");
           $pdf->Cell(28, 5, $fila['telefono_afil'], 1, 1, "L");
