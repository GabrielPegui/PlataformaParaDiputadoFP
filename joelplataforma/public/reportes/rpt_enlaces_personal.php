...
if($funcion == 1){
   ...
   $sql="select cedula,nombre,apellido,telefono,sector from miembros where cedula_enlace=$cedula_user and funcion=2";
...
$v_subtitulo='EQUIPO ENLACE DE: '.$nombreC.' '.$apellidoC;
